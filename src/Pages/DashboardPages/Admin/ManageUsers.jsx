                ...
                <div className='fixed px-2 bottom-3 w-full container lg:w-[1000px]'>
                    <form onSubmit={handelSearch}>
                        ...
                        <div className="relative">
                            ...
                            <input type="search" name='search' className="block w-full p-4 ps-10 text-lg text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500" required />
                            <button type="submit" className="text-white px-8 absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                        </div>
                    </form>
                </div>
            </div>
