...
const EditBio = () => {
    ...
    const { data, isLoading, refetch } = useAllBiodatas();
    const userAnyBiodataOrNot = data?.find(human => human?.userEmail === user?.email);
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-2">
                            ...
                            <div>
                                <button
                                    ...
                                    <p>Save And Publish Now Button</p>
                                </button>
                            </div>
                        </form> :
                        <UpdateBiodata
                            ...
                            user={user}
                            URL={URL}
                            axioPublicInstance={axioPublicInstance}
                            axiosSecureInstance={axiosSecureInstance}
                        />
                }
            </div>
